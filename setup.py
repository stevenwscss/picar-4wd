...
def install():
    ...
    if ".picar-4wd" not in listdir("/home/stevenpi"):
        do(msg="create .picar-4wd directory",
            cmd='run_command("sudo mkdir /home/stevenpi/.picar-4wd/")')
    do(msg="copy picar-4wd-config",
        cmd='run_command("sudo cp ./data/config /home/stevenpi/.picar-4wd/config")')
    do(msg="change directory owner",
        cmd='run_command("sudo chown -R stevenpi:stevenpi /home/stevenpi/.picar-4wd/")')
